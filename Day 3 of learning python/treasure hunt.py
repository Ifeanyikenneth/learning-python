...
if road1 == "left":
    road2 = input('you came to a lake there is an island in the middle of the lake. type "wait" to wait for a boat. type "swim" to swim across \n').lower()
    ...
    if road2 == "wait":
        ...
        if road3 == "yellow":
            ...
            print(f"finally you found the treasure, you won the game {win1}")
